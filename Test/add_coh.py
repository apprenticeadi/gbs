...
# TO DO: add logging functions, timestamp etc. do everything properly


n_samples = 100

M_list = [2,3,4,5,6,7,8,9,10]  # M must be integer, not numpy.int32, otherwise will cause problems with strawberry fields
...
for M in M_list:
    ...
    for coh_ind in coh_ind_ls:
        ...
        file_name = r'..\Results\M={}_coh={}_r={}_alpha={}_{}.csv'.format(M, coh_ind, r, alpha, date_stamp)
