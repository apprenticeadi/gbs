...
def calc_loop_hafnian_approx_batch(A_n, D_n, approx=2, glynn=False):
    """
    ...
    if approx >= N2:
        ...
        return loop_hafnian(A_n, D_n,
                            glynn=glynn)  # _calc_loop_hafnian(A_n, D_n, np.ones(N // 2, dtype=np.int64), glynn=glynn)
    else:
        H = 0
